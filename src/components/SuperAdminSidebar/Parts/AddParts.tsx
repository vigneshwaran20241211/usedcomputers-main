...
const AddParts = (params) => {
  ...
  useEffect(() => {
    ...
    if (params.id != "new") {
      axios
        .get(`${process.env.API_URL}parts/${params.id}`, {
          headers: {
    ...
    try {
      if (data.id) {
        const response = await axios.put(
          `${process.env.API_URL}parts/${data.id}`,
      ...
      router.push("/superadmin/master/viewparts");
    } catch (error) {
      const err = error as {
  ...
  return (
    <>
      <ProtectedRoute allowedRoles={["ADMIN"]}>
        ...
        <Breadcrumb pageName="Master / Parts" />
          ...
          <div className="flex flex-col gap-9">
            ...
            <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
              <div className="border-b border-stroke px-6.5 py-4 dark:border-dark-3">
                ...
                <Link href="/superadmin/master/viewparts">
                  <button
                    type="button"
                ...
                <div className="p-6.5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      placeholder="Enter a Parts Name"
                      required
                    />
                    <input
                      type="text"
                      ...
                      value={data.code}
                      className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                      placeholder="Enter a Parts Code"
                      required
                    />
                  </div>
                  <div className="w-full">
