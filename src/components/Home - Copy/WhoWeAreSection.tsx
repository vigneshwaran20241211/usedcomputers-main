...
const WhoWeAreSection: React.FC = () => {
  return (
    <section className="who-we-are bg-no-repeat bg-cover dots pt-[50px] pb-[140px]">
      <div className="container mx-auto">
        <div>
          <div className="provider pl-[540px]">
            <h1 className="font-extrabold text-primary text-38 pb-2">
              Malaysia’s Leading <span className="text-secondary">E-Waste</span> Solution Provider
            </h1>
            <p className="italic text-info text-2xl">
              Your green solution to an efficient and reliable disposal of your electronic waste management system.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-12 pt-[124px]">
            <div className="who-left">
              ...
              <h1 className="font-extrabold text-primary text-38 pb-6">
                Your <span className="text-secondary">green</span> partner, anyplace, at your own convenience.
              </h1>
              <div className="quote">
                <p className="italic text-info text-xl border-l-2 pl-4 border-secondary mb-4">
                  With over <span className="font-bold">10 years</span> experience in E-Waste collection and processing management.
                </p>
              </div>
              <div className="learn-more py-7">
              ...
              <h6 className="font-black uppercase text-secondary text-xl mb-3 flex items-center">
                <span>
                  <svg
                    width="43"
                    height="44"
                  ...
                  >
                    ...
                    />
                    <path
                      d="M29 17.3L21.5 22.8L13.5 17.3"
                      stroke="#5CA845"
                      strokeWidth="2"
                    />
                    <path
                      d="M30 26.3L21.5 30.8L13 26.8"
                      stroke="#5CA845"
                      strokeWidth="2"
                    />
                  </svg>
              ...
              <h5 className="font-extrabold text-primary text-xl">
...
className="h-auto max-w-full"	
    alt="Waste Image" 
    width={600}  // Replace with the width you want
    height={400} // Replace with the height you want
  />
            </div>
          </div>
        </div>
