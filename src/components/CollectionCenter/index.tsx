    ...
    menuItems: [
      {
        ...
        label: "Dashboard",
        route: "/collectioncenter/dashboard",
      },
      {
        icon: (
          <svg
        ...
        label: "Collection",
        route: "/collectioncenter/collection/viewcollection",
      },
      {
        icon: (
          <svg
        ...
        label: "Booking",
        route: "/collectioncenter/booking/viewbooking",
      },
      {
        icon: (
          <svg
        ...
        route: "#",
        children: [
          { label: "Consignement Details", route: "/collectioncenter/reports/consignementdetails" },
          // { label: "Waste Collection", route: "/collectioncenter/reports/wastecollection" },
          // { label: "Waste Collection Summery", route: "/collectioncenter/reports/wastecollectionsummery" },
          // { label: "Consignment Status", route: "/collectioncenter/reports/consignmentstatus" },
          // { label: "Waste Disposal", route: "/collectioncenter/reports/wastedisposal" },
          { label: "Bookings Search", route: "/collectioncenter/reports/bookingsearch" }
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Documents", route: "/collectioncenter/ebilling/document" },
          { label: "Payment Status", route: "/collectioncenter/wallet" },
        ],
      },
      // {
      //   icon: (
