...
const WasteCollectionReport = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-xl font-bold mb-4">Consignment Status Report</h2>
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="flex items-center col-lg-4">
          <label htmlFor="sortBy" className="text-sm font-medium mr-2">Waste Name:</label>
          <input type="text" name="" className="border border-gray-300 rounded-md p-2"></input>
        </div>
      ...
      <div className="flex justify-between mb-4">
        <div className="flex items-center col-lg-4">
          <label htmlFor="sortBy" className="text-sm font-medium mr-2">CN No:</label>
          <input type="text" name="" className="border border-gray-300 rounded-md p-2"></input>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4">Consignment Status Report</h2>
        ...
        <table className="w-full border-collapse border">
          <thead>
            <tr>
              ...
              <th className="border p-2">Original CN</th>
