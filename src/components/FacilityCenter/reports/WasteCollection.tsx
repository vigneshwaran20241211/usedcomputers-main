...
const WasteCollectionReport = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-xl font-bold mb-4">Waste Collection Report</h2>
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="flex items-center col-lg-4">
          <label htmlFor="cnNo" className="text-sm font-medium mr-2">CN No:</label>
          <select
            id="cnNo"
            value={cnNo}
          ...
          >
            ...
            {/* Add CN No options here if available */}
          </select>
        </div>
      </div>
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="flex items-center col-lg-4">
          ...
          >
            ...
            <option value="CN No">CN No</option>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-xl font-semibold mb-4">Waste Collection Report</h2>
      ...
      <table className="w-full border-collapse border">
        <thead>
          <tr>
            ...
            <th className="border p-2">Waste Category</th>
